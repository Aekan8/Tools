...
redis:set(boss.."GAME:SE"..msg.chat_id_,true) 
K1 = [[
✖️¦12+12+4 ⚜️
]]
K2 = [[
...
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'68') 
elseif SENDTEXT:find('114') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'114') 
elseif SENDTEXT:find('164') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'164') 
elseif SENDTEXT:find('194') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'194') 
elseif SENDTEXT:find('28') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'28') 
elseif SENDTEXT:find('62') then
redis:set(boss.."GAME:CHER"..msg.chat_id_,'62') 
elseif SENDTEXT:find('109') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'109') 
elseif SENDTEXT:find('88') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'88') 
elseif SENDTEXT:find('192') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'192') 
elseif SENDTEXT:find('115') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'115') 
elseif SENDTEXT:find('124') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'124') 
elseif SENDTEXT:find('102') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'102') 
elseif SENDTEXT:find('107') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'107') 
elseif SENDTEXT:find('90') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'90') 
elseif SENDTEXT:find('182') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'182') 
elseif SENDTEXT:find('122') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'122') 
elseif SENDTEXT:find('195') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'195') 
elseif SENDTEXT:find('123') then
redis:set(boss.."GAME:CHERE"..msg.chat_id_,'123') 
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
redis:set(boss.."eng:lsh"..msg.chat_id_,true) 
Ke1 = [[
✖️¦ 
...
redis:set(boss.."eng:ken"..msg.chat_id_,'كتاب') 
elseif SENDTEXT:find('قطه') then
redis:set(boss.."eng:ken"..msg.chat_id_,'قطه') 
elseif SENDTEXT:find('باب') then
redis:set(boss.."eng:ken"..msg.chat_id_,'باب') 
elseif SENDTEXT:find('حاسبه') then
redis:set(boss.."eng:ken"..msg.chat_id_,'حاسبه') 
elseif SENDTEXT:find('فاره') then
redis:set(boss.."eng:ken"..msg.chat_id_,'فاره') 
elseif SENDTEXT:find('كنتور') then
redis:set(boss.."GAME:CHER"..msg.chat_id_,'كنتور') 
elseif SENDTEXT:find('انترنت') then
redis:set(boss.."eng:ken"..msg.chat_id_,'انترنت') 
elseif SENDTEXT:find('منضده') then
redis:set(boss.."eng:ken"..msg.chat_id_,'منضده') 
elseif SENDTEXT:find('شيطان') then
redis:set(boss.."eng:ken"..msg.chat_id_,'شيطان') 
elseif SENDTEXT:find('ضوضاء') then
redis:set(boss.."eng:ken"..msg.chat_id_,'ضوضاء') 
elseif SENDTEXT:find('سنه') then
redis:set(boss.."eng:ken"..msg.chat_id_,'سنه') 
elseif SENDTEXT:find('بيت') then
redis:set(boss.."eng:ken"..msg.chat_id_,'بيت') 
elseif SENDTEXT:find('معده') then
redis:set(boss.."eng:ken"..msg.chat_id_,'معده') 
elseif SENDTEXT:find('كاحل') then
redis:set(boss.."eng:ken"..msg.chat_id_,'كاحل') 
elseif SENDTEXT:find('خجول') then
redis:set(boss.."eng:ken"..msg.chat_id_,'خجول') 
elseif SENDTEXT:find('هديه') then
redis:set(boss.."eng:ken"..msg.chat_id_,'هديه') 
elseif SENDTEXT:find('جزار') then
redis:set(boss.."eng:ken"..msg.chat_id_,'جزار') 
elseif SENDTEXT:find('تصميم') then
redis:set(boss.."eng:ken"..msg.chat_id_,'تصميم') 
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
if (msg.text == redis:get(boss.."GAME:CHER"..msg.chat_id_)) and redis:get(boss.."GAME:S"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'')     
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,0)  
redis:del(boss.."GAME:S"..msg.chat_id_)
redis:del(boss.."GAME:CHER"..msg.chat_id_)
...
if (msg.text == redis:get(boss.."GAME:CHERE"..msg.chat_id_)) and redis:get(boss.."GAME:SE"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'')     
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,0)  
redis:del(boss.."GAME:SE"..msg.chat_id_)
redis:del(boss.."GAME:CHERE"..msg.chat_id_)
...
if redis:get(boss.."GAME:SE"..msg.chat_id_) then  
local list = {'68' , '114' , ' 62' , '164' , '194' , '28' , '109' , '192' , '88' , '102' , '124' , '115' , '90' , '107' , '182' , '123' , '195' , '122'}
for k, v in pairs(list) do 
if msg.text ~= v then
sendMsg(msg.chat_id_,msg.id_,'📮¦*\n🎮║((رياضيات))\nء➖➖➖➖➖➖™\n🖲¦  •⊱ {اجابه صحيحه} ⊰•\n🖲¦  •⊱ { حصلت على⁴مجوهرات } ⊰•*')     
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,4)  
redis:del(boss.."GAME:SE"..msg.chat_id_)
redis:del(boss.."GAME:CHERE"..msg.chat_id_)
return true   
end
...
if (msg.text == redis:get(boss.."eng:ken"..msg.chat_id_)) and redis:get(boss.."eng:lsh"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'')     
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,0)  
redis:del(boss.."eng:lsh"..msg.chat_id_)
redis:del(boss.."eng:ken"..msg.chat_id_)
...
if redis:get(boss.."eng:lsh"..msg.chat_id_) then  
